...
BosR was originally identified as a potential Fur (regulator of iron uptake)  homolog. \textit{Borrelia burgdorferi} was discovered to is unique in its ability   BosR was initially characterized as the \textit{Borrelia burgdorferi} oxidative stress response regulator. 
In contrast to previous work they claim BosR serves as a transcriptional activator rather than a repressor for the oxidative stress response(Boylan et al.(2003)) 
\subsection*{Role of BosR in Gene Regulation}

\section*{Previous BosR DNA Binding Studies}


		After determining the critical role BosR plays in regulation of genes that encode virulence factors, researchers investigated the mechanism behind regulation. Boylan et al.(2003)found that BosR binds in the promoter region of \textit{napA}  However, they noted that for optimal binding DTT and Zn were required. 

		 In 2011, Ouyang et al. investigated the mechanism by which BosR serves as a positve transcriptional activator of \textit{rpoS}, an alternative sigma factor. Based on \textit{in silico} analysis that suggested structural similarity in DNA binding domains to PerR protein from \textit{Bacillus subtilis} and Fur protein from \textit{Vibrio cholerae}, they wondered if BosR functioned by directly binding \textit{rpoS}. Electrophoretic mobility shift assays (EMSAs) were performed with labeled DNA that encompassed a 277 bp region upstream of \textit{rpoS} and a 245 bp region in the \textit{rpoS} encoding region. Recombinant BosR was found to bind the sequence in a dose-dependent manner and showed multiple bands, which suggested more than one binding site existed within the sequence. DNase I footprinting supported their hypothesis of three binding sites. Upon sequence analysis of the three regions identified by footprinting, they hypothesized that BosR bound to the direct repeat sequence (TAAATTAAAT). This sequence, however, was present in one perfect and one imperfect direct repeat in two of  regions and one imperfect direct repeat in the third region. Mutations to the direct repeat sequence did affect binding, in some cases completely abolishing it and in others simply decreasing it.  
		 
		 Wang et al. (2013) through DNase I digestion did not find that BosR protected regions upstream of \textit{rpoS}, but found that it protected an upstream region of \textit{bosR}, suggesting it may auto-regulate its own transcription. They also found through EMSAs that BosR recognizes the Fur and Per box, which unsurprisingly both contain many As and Ts. 
		 
		  In 2014, Ouyang et al. published more work revising their hypothesized core binding sequence. They propose the sequence (ATTTAANTTAAAT) to be a putative 6-1-6 inverted repeat that serves as the "BosR box." This conclusion, however, was also made through  
		 
		 Given the amount of conflicting evidence from multiple research groups, a consensus target sequence for BosR has not been fully elucidated. Prior work has primarily used mutational or competitive binding approaches to tackle this issue. This thesis employs the CASTing (cyclic amplification and selection of targets) technique to determine the sequence(s) for which BosR has the highest affinity. 
\section*{What is CASTing?}
\section*{Github test}
